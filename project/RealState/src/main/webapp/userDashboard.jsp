            ...
            <div class="col-lg-10">
                ...
                <div class="dashboard-card">
                    ...
                    <div class="property-card">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <img src="property1.jpg" alt="Property" class="rounded" style="width: 80px; height: 60px; object-fit: cover;">
                            </div>
                            <div class="col">
                    ...
                    <div class="property-card">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <img src="property2.jpg" alt="Property" class="rounded" style="width: 80px; height: 60px; object-fit: cover;">
                            </div>
                            <div class="col">
